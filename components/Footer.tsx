...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-white border-t-4 border-[#b91c1c] pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="md:flex md:justify-between md:items-center border-b border-gray-200 pb-8 mb-8">
          
          {/* Logo & Info */}
          <div className="mb-8 md:mb-0">
            <div className="flex flex-col mb-4">
                <div className="bg-black text-white px-3 py-1 font-bold text-2xl italic tracking-tighter inline-block border-l-8 border-[#b91c1c] w-max">
                  COLORAMA
                </div>
            ...
            <div className="space-y-2 text-gray-600 text-sm">
              <p className="flex items-center">
                <svg className="w-4 h-4 text-[#b91c1c] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                +34 489 774 830
              </p>
              <p className="flex items-center">
                <svg className="w-4 h-4 text-[#b91c1c] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                info@colorama.com
              </p>
              <p className="flex items-center">
          ...
          <div className="flex space-x-6">
            <a href="#" className="text-gray-900 hover:text-[#b91c1c] transition">
            ...
            <a href="#" className="text-gray-900 hover:text-[#b91c1c] transition">
                ...
                <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 01-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 01-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 011.768-1.768C5.744 5 11.998 5 11.998 5s6.255 0 7.814.418zM15.194 12 10 15V9l5.194 3z" clipRule="evenodd" /></svg>
            </a>
          </div>
        </div>

        <div className="text-center">
            <p className="text-sm text-gray-500">© Copyright 2022 - Colorama.</p>
        </div>
      </div>
    </footer>
  );
